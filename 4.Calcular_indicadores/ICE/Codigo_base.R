...
calcular_ICE<-function(q_medio_mensual,Carac_gamma,acumulacion){
...
#write.csv(ICE12_MATRIZ, file = "ICE_12_1991_2023.csv")


##########VAMOS A ESCRIBIR LAS CARACTERÍSTICAS DE LAS ESTACIONES##########
#prueba <- data.frame(matrix(nrow = 8, ncol = ncol(ICE12_MATRIZ)))
...
#colnames(prueba) <- colnames(ICE12_MATRIZ)
#rownames(prueba) <- nombres_filas

#write.csv(prueba, file = "ICE_caracteristicas.csv")
